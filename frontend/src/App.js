...
import AIQuestionGenerator from "./pages/AIQuestionGenerator"; // NEW
...
function TopNav() {
  ...
  const atGenerator = loc.pathname.startsWith("/ai-generator");
  return (
      ...
      <div className="mx-auto max-w-screen-2xl px-4 py-2 flex items-center gap-3">
        ...
        <Link
          ...
          className={`px-3 py-1 rounded border text-sm ${
            loc.pathname === "/" ? "bg-indigo-50 border-indigo-200 text-indigo-700" : "bg-gray-100"
          }`}
        >
          Solve
        </Link>
        ...
        <Link
          to="/ai-generator"
          className={`px-3 py-1 rounded border text-sm ${
            atGenerator ? "bg-indigo-50 border-indigo-200 text-indigo-700" : "bg-gray-100"
          }`}
        >
          AI Generator
        </Link>
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/ai-generator" element={<AIQuestionGenerator />} /> {/* NEW */}
      </Routes>
    </BrowserRouter>
  );
}